...
'use strict';
(function () {
  var container = document.querySelector(".landscaping-form__img-container");

  if (container) {
    var input = container.querySelector('input[name="images"]');
    var label = container.querySelector('.landscaping-form__upload');
    var images = [];
    var MAX_IMAGES = 5;
    ...
    var renderCloseBtn = function (btnContainer, file) {
      ...
      button.classList.add("landscaping-form__remove-img");
    ...
    var renderPreview = function (imageUrl, file) {
      ...
      imgContainer.classList.add("landscaping-form__img");
